...
async def start_command(client, message):
    ...
    welcome_text = (
        ...
        f"3. I'll generate screenshots for you!\n\n"
...
async def animated_progress(status_message, action, total_steps):
    ...
    for i in range(total_steps):
        ...
        try:
            await status_message.edit_text(f"{action}{frame} ({i+1}/{total_steps})")
...
async def handle_file(client, message):
    ...
    status_message = await message.reply_text("Analyzing file...")
    
    # Show simple progress while analyzing
...
async def alternative_download(client, chat_id, message_id, file_path, status_message):
    ...
    try:
        ...
        # Show simple progress while downloading
